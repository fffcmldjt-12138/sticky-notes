export const ipcChannels = {
  ...
  siyuanSettingsGet: 'siyuan:settings-get',
  siyuanSettingsUpdate: 'siyuan:settings-update',
  siyuanTestConnection: 'siyuan:test-connection',
  siyuanSendNote: 'siyuan:send-note',
